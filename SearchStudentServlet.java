...
public class SearchStudentServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{  
			...
			//dynamic page for searched entities
			out.println("<div align = 'center'>");
			out.println("<h3>Student Details</h3>");
			ResultSet rs  = st.executeQuery(Queries.searchStudentQuery(first_name, last_name));
			out.println("<table border='1' cellspacing=5>");
			out.println("<tr><th>First Name</th><th>Last Name</th><th>Father's Name</th><th>Age</th><th>Class</th><th>Email</th></tr>");
			while ( rs.next() ) {
				out.print("<tr>");
