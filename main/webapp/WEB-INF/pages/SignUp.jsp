...
<BODY
	...
	<DIV ALIGN=CENTER
		...
		<form:form method='post' action='Registration' id="Form1"
			...
			<table cellspacing=15 style='color: white'>
				...
				<tr>
					...
					<td><form:radiobutton path="gender" value="Male" id="male" />Male<br />
				...
				<tr>
					<td><label style="color: red">*</label><label>Email
							id :</label></td>
					<td><form:input id="email" path='email' /></td>
				</tr>
				<tr>
					<td colspan=2><form:errors path="email" style="color:red" /></td>
				</tr>
				<tr>
					<td><label style="color: red">*</label><label>Password
							:</label></td>
					<td><form:input type="password" id="password" path="password" /></td>
				</tr>
				<tr>
					<td colspan=2><form:errors path="password" style="color:red" /></td>
				</tr>
				<tr>
					<td><label style="color: red">*</label><label>Confirm
							Password :</label></td>
					<td><form:input type="password" path="confirmPassword"
							name="confirmPassword" /></td>
				</tr>
				<tr>
					<td colspan=2><form:errors path="confirmPassword"
							style="color:red" /></td>
				</tr>
				<form:errors style="color:red" />
				<tr>
