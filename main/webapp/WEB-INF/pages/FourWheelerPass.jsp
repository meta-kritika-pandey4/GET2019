		...
		<form:form action="getPassDetails" method='Post' modelAttribute="pass">
			...
			<table cellspacing=15 style='color: white'>
				<tr>
					...
					<td><form:select path="currencyType"
							onchange='fourwheelerCurrency()'>
				...
				<tr>
					<form:input type='hidden' value='${vehicleNumber}'
						path='vehicleNumber' />
				</tr>
				<tr>
					<form:input type='hidden' value='${employeeId}' path='employeeId' />
				</tr>
				<tr>
					<form:input type='hidden' value='${vehicleType}' path='vehicleType' />
				</tr>
				<tr>
					<td><label>Daily :</label></td>
					<td><form:radiobutton value='00.28' path="passPrice"
							id='fourwheeler_pass1' /><label id='fwp1'>20 INR</label><br /></td>
				</tr>
				<tr>
					<td><label>Monthly :</label></td>
					<td><form:radiobutton value='07.00' path="passPrice"
							id='fourwheeler_pass2' /><label id='fwp2'>500 INR</label><br /></td>
				</tr>
				<tr>
					<td><label>Yearly :</label></td>
					<td><form:radiobutton value='49.00' path="passPrice"
							id='fourwheeler_pass3' /><label id='fwp3'>3500 INR</label><br /></td>
				</tr>
				<tr>
					<td colspan=2><form:errors path="passPrice" style="color:red" /></td>
				</tr>
				<tr>
					<td colspan=2><form:errors path="currencyType"
							style="color:red" /></td>
				</tr>
			</table>
			<br />
